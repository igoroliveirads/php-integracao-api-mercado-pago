    ...
    <body class="bg-light">
        ...
        <div class="container">
            <div class="py-5 text-center">
                <img class="d-block mx-auto mb-4" src="#LOGOAQUI" alt="" width="72"
                    height="72">
            ...
            <div class="row">
                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <form class="needs-validation" novalidate method="POST" action="./controllers.php">
                        <div class="row">
                        ...
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="same-address">Endereço de cobrança igual ao endereço de entrega</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                    ...
                    <input type="text" class="form-control" id="docNumber" data-checkout="docNumber" placeholder="" />
                        ...
                        <div class="mb-3"><label for="installments">Installments:</label>
                    <select id="installments" class="form-control" name="installments"></select></div>
                        <li>
                        <hr class="mb-4">
